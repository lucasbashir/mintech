...
function load() {
  ...
  fetch(`/group_load_posts/?start=${start}&end=${end}`)
...
const readMoreLink = postData.scrollPostId
  ? `<a style="color: white"; href="/group_post_content/${postData.scrollPostId}">Read full content, reactions and comments >>></a>`
  : '';
